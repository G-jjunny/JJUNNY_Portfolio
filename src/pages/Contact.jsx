    ...
    <StyledDiv isLast={isLast}>
      <div className="center">
        <div className="outTro">
          ...
          <p>
            저는 학습한 기술을 바탕으로 더욱 전문성을 키워 새로운 기술과
            트렌드에 대한 열린 마음으로 접근하며 프론트엔드 분야에서 전문적인
            역량을 갖출 수 있도록 노력하고 있습니다.
          </p>
          <p>
            또한, 협업하는 동료 개발자, 디자이너 및 기획자와의 커뮤니케이션
            능력으로 프로젝트의 성과를 극대화함으로써 사용자에게 더 나은
            서비스를 제공하고 기술적이며 인적으로 더욱 성장한 프론트엔드
            개발자될 수 있도록 노력하겠습니다.
          </p>
        </div>
